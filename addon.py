...
# Var to hold  the path where the remmina executable is
executable = ""
...
if platform.system() == "Windows":
    ...
    # Otherwise it is Linux because remmina currently runs on Windows, Debians and RetroPie
...
if not os.path.isfile(executable):
    # This message prints something like: remmina executable was not found, go to Addon-Configure and change it
    ...
    # This message prints something like: Please check that remmina is installed
    xbmcgui.Dialog().ok(__localizedMessages__(32004), __localizedMessages__(32005))
    # Log the error
    log("remmina executable was not found on this specified location: " + executable, xbmc.LOGERROR)
    ...
    log("Starting remmina executable: " + executable)
